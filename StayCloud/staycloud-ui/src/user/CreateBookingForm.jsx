...
function CreateBookingForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const confirmation = res.data.confirmationCode;
      alert(`Boeking succesvol! Bevestigingscode: ${confirmation}`);
    } catch (err) {
      console.error("Fout bij maken boeking:", err);
